import { useEffect, createElement, Fragment, PureComponent } from 'react';
...
clientID }) => {
    ...
    let [state, setState] = useStorage(oauthStateName);
    const getToken = () => {
 ...
 * @hidden
 */
const urlDecode = (urlString) => Map(urlString.split('&').map((param) => {
...
const OAuthCallbackHandler = () => {
    ...
    return createElement(Fragment, null, "'please wait...'");
};
/**
...
errorBoundary = true }) => {
    if (errorBoundary === false)
        return createElement(OAuthCallbackHandler, null);
    return createElement(ClosingErrorBoundary, null,
        createElement(OAuthCallbackHandler, null));
};
 ...
 * @hidden
 */
class ClosingErrorBoundary extends PureComponent {
...
export { useOAuth2Token, ErrIncorrectStateToken, ErrNoAccessToken, OAuthCallback };
